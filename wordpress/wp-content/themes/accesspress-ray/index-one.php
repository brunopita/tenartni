...
<div class="container">
	<section class="principal-info">
		<section class="posts">	
			<h1 class="title-content"><?php _e('Últimas Postagens','accesspress_ray') ?></h1>			
...
<section class='news'>
	<aside class='news-content'>
		<h3 class='title-content small'>CAMPANHA DO AGASALHO</h3>
		<img src="" class='image-news' alt='Imagem ilustrativa'>
		<p class='description'>Lorem ipsum dolor sit amet, consectetuer 
			adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, 
			magna sed.
		</p>
		<p class='link leiamais'><a href="#" title='Link'>Leia mais</a></p>
	</aside>
	<aside class='news-content'>
		<h3 class='title-content small'>CONCURSO REDAÇÃO</h3>
		<img src="" class='image-news' alt='Imagem ilustrativa'>
		<p class='description'>Lorem ipsum dolor sit amet, consectetuer 
			adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, 
			magna sed.
...
>>>>>>> a844dab90dbda2550af0e760f408eabba4ea6f36
